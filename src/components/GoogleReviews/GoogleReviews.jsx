...
const FALLBACK_REVIEWS = [
  ...
  },
  {
    ...
    rating: 5,
    time: "4 months ago",
    text: "Great place to learn website design. Teachers are very supportive and approachable.",
  },
  {
    name: "Rahul Yadav",
    image: "",
    rating: 5,
    time: "2 months ago",
    text: "The web development training helped me build real projects and land a job.",
  },
  {
    name: "Pooja Sharma",
    image: "",
    rating: 5,
    time: "5 months ago",
    text: "Graphic design course is amazing. I learned Photoshop, Illustrator and Canva professionally.",
  },
];
    ...
    const fetchLiveReviews = async () => {
      try {
        ...
        // Case 2: API returns data directly as array
          ...
          avgRating =
            formattedReviews.reduce((sum, r) => sum + r.rating, 0) / total;
        }
  ...
  return (
    <>
      <section className="gr-section">
        ...
        <div className="gr-header">
          {/* <span className="gr-badge">
            <span className="gr-badge-dot">Verified Reviews</span>
          </span> */}
          {/* <h2 className="gr-title">
            What Our <span className="gr-accent">Students</span> Say
          </h2> */}
           {/* <p className="gr-subtitle">
            Real reviews from Google — straight from our students in Jaipur.
          </p> */}
   ...
   <div className="about-header">
          <h2 className="about-title">
            ...
            <span className="about-highlight">Students Say</span>
          </h2> 
          ...
          {!error && overallRating && (
            <div className="gr-overall">
              <span className="gr-overall-score">
